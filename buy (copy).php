...
$Pipe->setResponseURL("http://13.126.44.143/seegetwear/webroot/knet/result.php"); // set your respone page URL
$Pipe->setErrorURL("http://13.126.44.143/seegetwear/webroot/knet/error.php"); //set your error page URL
